...
class Settings(object):
    ...
    def __init__(self, root):
        ...
        # swyoo 2015.11.18. change z_feedrate 100->260 matching with marlin ftrmware
        # self._add(SpinSetting("z_feedrate", 100, 0, 50000, _("Z manual feedrate"), _("Feedrate for Control Panel Moves in Z (mm/min)"), "Printer"))
        self._add(SpinSetting("z_feedrate", 240, 0, 50000, _("Z manual feedrate"), _("Feedrate for Control Panel Moves in Z (mm/min)"), "Printer"))
        ...
        # swyoo 2015.10.30 change value
        self._add(HiddenSetting("last_extrusion", 10.0))    # self._add(HiddenSetting("last_extrusion", 5.0))
